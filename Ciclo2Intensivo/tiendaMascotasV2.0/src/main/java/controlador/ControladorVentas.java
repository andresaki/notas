...
public class ControladorVentas {
        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    ControladorVendedor controlVen = new ControladorVendedor();
                    controlVen.trabajarVendedor();
                    break;
                case 7:
                    exportarPLANO();
                    break;
    ...
    public static void ingresar() {
        ...
        try ( Connection conn = DriverManager.getConnection(URL, USER, CLAVE);  Statement stmt = conn.createStatement();) {
            String sql = "INSERT INTO ventas (id, fecha, numVenta, cliente, "
                    ...
                    + precio + "," + cantidad + ",'" + vendedor.getCedula() + "');";
    ...
    public static void Modificar() {
        ...
        if (aModificar != null) {
            ...
            System.out.println("Ingrese No. de Cedula del responsable de la venta: \n");
            String cedula = input.nextLine();
            Vendedor vendedor= buscarVendedor(cedula);
    ...
    public static void exportarPLANO() {
