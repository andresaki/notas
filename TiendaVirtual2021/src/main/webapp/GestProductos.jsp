...
<div class="login">
  ...
  <h2 class="login-header"><img src="assets/logo.png"><br>Gestión de Productos</h2>

  <form class="login-container" action="/Grupo11Cucuta/Productos.jsp" method="post">
    <input type="submit" name="create" id="create" value="Registrar Productos">
  </form>
   <form class="login-container" action="/Grupo11Cucuta/ConsultaProductos.jsp" method="post">
    <input type="submit" name="update" id="update" value="Consultar Productos">
  </form>
   <form class="login-container" action="/Grupo11Cucuta/CargueMasivoProducto.jsp" method="post">
